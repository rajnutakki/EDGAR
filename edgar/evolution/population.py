    ...
    def load(cls, path: str) -> Population:
        ...
        with open(path) as f:
            for line in f:
                ...
                # Reconstruct LossPair objects from the dictionary
                discover_losses = d["program_losses"]["discover"]
                validate_losses = d["program_losses"]["validate"]
                ...
                program = Program(
                    ...
                    program_losses=Losses(
                        discover=LossPair(**discover_losses),
                        validate=LossPair(**validate_losses),
                    ),
                    n_params=d["n_params"],
